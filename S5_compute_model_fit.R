...
for(model in 1:nm){
  ...
  partition = createPartition(m, nfolds = 5)  # you need to change the number of partitions
  preds = computePredictedValues(m,partition=partition, nParallel = nChains) #nParallel = nChains
