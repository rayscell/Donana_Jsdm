...
# 
# # Separate the code without space model: perform to reduce the error.
# # nm = length(models)
# ns <- 2
# filename = paste("panels/parameter_estimates2NO_space.pdf")
# nm
# for(j in 1:ns){
#   m = models[[j]]
#   OmegaCor = computeAssociations(m)
...
# 
# head(models[[1]])$X
# groupnames= c("Units", "HIDRO_MEAN_500", "NDVI_2000", "DIST_ARROZ", "DIST_urbano" )
# group <- c(1,1,1,1,1,1,2,3,4,5)
# VP <- list()
# for ( i in 1:2){
